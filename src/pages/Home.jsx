...
const services = [
  {
    ...
    title: "AI Solutions",
    description:
      "Transform business operations with intelligent automation and AI-driven decision making.",
    value:
      "Reduce overhead while improving decision accuracy at scale.",
    color: "#6366F1",
  ...
  },
  {
    ...
    title: "AI Agents",
    description:
      "Deploy autonomous agents that handle multi-step tasks and workflows without human intervention.",
    value:
      "Extend your team's capacity with agents that work around the clock.",
    color: "#3B82F6",
  ...
  },
  {
    ...
    title: "AI Chatbots",
    description:
      "Context-aware conversational interfaces that resolve queries and support customers in real time.",
    value:
      "Deliver instant, consistent support across every touchpoint.",
    color: "#8B5CF6",
  ...
  },
  {
    ...
    description:
      "Eliminate repetitive tasks and improve efficiency with smart automation across your business.",
    value:
      "Reclaim hundreds of hours annually with intelligent orchestration.",
    color: "#A855F7",
  ...
  },
  {
    ...
    description:
      "Scalable digital products engineered with precision to support long-term business growth.",
    value:
      "Built to last — architecture that scales with your ambitions.",
    color: "#6366F1",
    bg: "rgba(99,102,241,0.08)",
    image:
  ...
  },
  {
    ...
    description:
      "High-performance web platforms with modern UI/UX that turn complex workflows into seamless experiences.",
    value:
      "Conversion-focused interfaces backed by rock-solid engineering.",
    color: "#3B82F6",
    bg: "rgba(59,130,246,0.08)",
    image:
  ...
  },
  {
    ...
    description:
      "Native and cross-platform mobile apps designed for engagement, retention, and real-world utility.",
    value:
  ...
  },
  {
    ...
    description:
      "Enterprise resource planning that unifies operations, inventory, finance, and supply chain.",
    value:
      "Full operational visibility — in one system.",
    color: "#64748B",
  ...
  },
  {
    ...
    description:
      "CRM platforms that give your sales and support teams a decisive competitive edge.",
    value:
      "Know your customers better. Close deals faster.",
    color: "#EC4899",
  ...
  },
  {
    ...
    description:
      "Infrastructure design, cloud migration, and managed services for reliability and global reach.",
    value:
      "Enterprise-grade uptime — without the enterprise overhead.",
    color: "#0EA5E9",
  ...
  },
  {
    ...
    description:
      "Transform raw data into strategic intelligence with pipelines, models, and executive reports.",
    value:
      "Stop guessing. Start deciding with real data.",
    color: "#F59E0B",
  ...
  },
  {
    ...
    title: "Dashboards",
    description:
      "Real-time operational dashboards that surface KPIs, trends, and anomalies when your team needs them.",
    value:
      "Every stakeholder sees the right data at the right moment.",
    color: "#A855F7",
    bg: "rgba(168,85,247,0.08)",
    image:
  ...
  },
  {
    ...
    description:
      "CI/CD pipelines, container orchestration, and infrastructure-as-code for confident shipping.",
    value:
      "Faster releases, zero-downtime deployments, full audit trails.",
    color: "#475569",
...
const products = [
  {
    ...
    name: "ERP System",
    description:
      "End-to-end enterprise resource planning built for operational clarity.",
    useCase:
      "Unify procurement, finance, inventory, and HR in one auditable system.",
    color: "#6366F1",
    image:
  ...
  },
  {
    ...
    name: "HRMS Platform",
    description:
      "Modern workforce management built for growing organizations.",
    useCase:
      "Automate payroll, attendance, appraisals, and compliance at any scale.",
    color: "#3B82F6",
    image:
  ...
  },
  {
    ...
    description:
      "Digitize appointments, billing, and patient operations with precision.",
    useCase:
      "From consultation to discharge — every step tracked, nothing lost.",
    color: "#10B981",
    image:
  ...
  },
  {
    ...
    name: "School ERP",
    description:
      "Unified academic and administrative management for modern institutions.",
    useCase:
      "Admissions, timetables, results, and communication — one platform.",
    color: "#8B5CF6",
    image:
  ...
  },
  {
    ...
    name: "AI Assistants",
    description:
      "Intelligent conversational tools trained on your business knowledge.",
    useCase:
      "Onboard faster, support smarter, surface insights on demand.",
    color: "#6366F1",
    image:
  ...
  },
  {
    ...
    description:
      "Business intelligence infrastructure built for strategic leaders.",
    useCase:
      "Connect every data source. Visualize trends. Act on what matters.",
    color: "#F59E0B",
    image:
  ...
  },
  {
    ...
    description:
      "Turn business data into actionable insights and real-time decisions.",
    useCase:
      "Role-specific views for executives, operations, and field teams.",
    color: "#EC4899",
    image:
  ...
  },
  {
    ...
    name: "Custom SaaS",
    description:
      "Full-stack SaaS platforms engineered around your unique business model.",
    useCase:
      "From MVP to enterprise-grade — we build products that scale with you.",
    color: "#0EA5E9",
    image:
...
const educationOfferings = [
  {
    ...
    description:
      "Hands-on internships where students work on live client projects — not simulations.",
  },
  {
    icon: Award,
    title: "Industry Training",
    description:
      "Domain-specific training programs designed by practitioners, delivered with real tools.",
  },
  {
    icon: Lightbulb,
    title: "Workshops & Bootcamps",
    description:
      "Intensive learning experiences that compress months of learning into focused days.",
  },
  {
    icon: BookOpen,
    title: "Mentorship Programs",
    description:
      "1-on-1 and cohort mentorship from working engineers and AI professionals.",
  },
];
...
const whyUs = [
  {
    ...
    description:
      "Every solution we build starts with the question: how can intelligence make this better? AI isn't an add-on — it's foundational.",
  },
  {
    icon: Layers,
    title: "Scalable Architecture",
    description:
      "We engineer for where your business is going, not just where it is. Systems built today must carry tomorrow's load.",
  },
  {
    icon: ShieldCheck,
    title: "Enterprise Security",
    description:
      "Security is embedded at the architecture level — not bolted on at the end. Your data is always protected.",
  },
  {
    icon: HeartHandshake,
    title: "Long-Term Partnership",
    description:
      "We don't disappear after launch. We build relationships that last through iterations, pivots, and growth stages.",
  },
  {
    icon: Zap,
    title: "Innovation-Driven",
    description:
      "We track the frontier of AI and engineering so your business benefits from what's possible today.",
  },
  {
    icon: CheckCircle2,
    title: "Business-Outcome Focus",
    description:
      "Technology is the means, not the end. Every line of code is measured against a business result.",
  },
];
...
const process = [
  {
    ...
    description:
      "We begin with deep listening — understanding your operations, goals, and constraints before writing a single line of code.",
  },
  {
    step: "02",
    title: "Architecture & Design",
    description:
      "We design systems with the future in mind — scalable, secure, and built on the right foundations for your use case.",
  },
  {
    step: "03",
    title: "Build & Iterate",
    description:
      "Agile development with continuous feedback loops. You see progress, provide input, and stay in control throughout.",
  },
  {
    step: "04",
    title: "Deploy & Scale",
    description:
      "Production-grade deployment with monitoring, optimization, and infrastructure that grows as your business grows.",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 0 36px ${color}22, 0 8px 32px rgba(0,0,0,0.35)`
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center pt-20 pb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(105deg, rgba(5,8,22,0.96) 0%, rgba(5,8,22,0.80) 42%, rgba(5,8,22,0.35) 75%, rgba(5,8,22,0.15) 100%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #050816, transparent)",
            }}
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:ml-[-24px] px-2 sm:px-0">
              ...
              <div
                ...
                style={{
                  ...
                  fontStyle: "italic",
                  animation:
                    "fadeSlideUp 0.7s cubic-bezier(.22,1,.36,1) both",
                }}
              >
              ...
              <p
                ...
                style={{
                  color: "#94A3B8",
                  animation:
                    "fadeSlideUp 0.75s 0.2s cubic-bezier(.22,1,.36,1) both",
                  fontFamily: FONT_BODY,
                  fontStyle: "italic",
                  fontWeight: 400,
                }}
              >
                GD AI Solutions engineers AI-powered software, intelligent
                automation, and enterprise platforms that give ambitious
                organizations a decisive technological edge.
              </p>
              ...
              <div
                ...
                style={{
                  animation:
                    "fadeSlideUp 0.75s 0.3s cubic-bezier(.22,1,.36,1) both",
                }}
              >
                <Link
                  to="/contact"
                  className="group inline-flex items-center gap-2 px-5 sm:px-7 py-3 sm:py-3.5 rounded-full text-white font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                    background:
                      "linear-gradient(135deg, #6366F1 0%, #3B82F6 100%)",
                    boxShadow:
                      "0 0 32px rgba(99,102,241,0.4), 0 4px 20px rgba(0,0,0,0.4)",
                    fontFamily: FONT_BODY,
                    fontStyle: "italic",
                  }}
                >
              ...
              <div
                ...
                style={{
                  animation:
                    "fadeSlideUp 0.75s 0.4s cubic-bezier(.22,1,.36,1) both",
                }}
              >
                {[
            ...
            >
              ...
              >
                ...
                >
                  {progress}% efficiency gain detected
                </p>
              </div>
              ...
              >
                ...
                >
                  Intelligent decisions at every layer of your stack
                </p>
              </div>
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, transparent, rgba(99,102,241,0.15), transparent)",
                }}
              />
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
              ...
              >
                An AI company built for businesses that can't afford to fall
                behind
              </h2>
              ...
              >
                GD AI Solutions combines artificial intelligence, enterprise
                software, and deep engineering to help organizations automate
                intelligently, operate efficiently, and scale confidently.
              </p>
            </div>
          </Reveal>
            ...
            {services.map((svc, i) => (
              <Reveal key={svc.title} delay={(i % 4) * 60}>
                ...
                >
                  ...
                  <h3
                    className="font-semibold mb-1.5 sm:mb-2 text-sm"
                    style={{
                      color: "#F1F5F9",
                      fontFamily: FONT_DISPLAY,
                      fontStyle: "italic",
                  ...
                  <p
                    className="text-xs font-medium leading-snug pb-3 mb-3"
                    style={{
                      color: "#94A3B8",
                      borderBottom:
                  ...
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-1 text-xs font-semibold transition-all duration-150 hover:gap-2"
                    style={{
                      color: svc.color,
                      fontFamily: FONT_BODY,
                      fontStyle: "italic",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <Reveal>
              ...
              >
                GD AI Solutions runs structured learning programs that bridge
                the gap between academic theory and real industry practice. We
                don't just build technology — we build the next generation of
                engineers who will carry it forward.
              </p>
      ...
      >
        ...
        <div
          className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[300px] rounded-full"
          style={{
            background:
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
              ...
              >
                A growing family of brands across industries who partner with
                GD AI Solutions.
              </p>
            </div>
          </Reveal>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(99,102,241,0.3), rgba(59,130,246,0.3))",
              }}
            />
            ...
            {process.map((item, i) => (
              ...
              >
                ...
                >
                  <div
                    className="w-10 sm:w-11 h-10 sm:h-11 rounded-xl flex items-center justify-center mb-4 sm:mb-5 text-sm font-bold text-white"
                    style={{
                      background:
                        "linear-gradient(135deg, #6366F1 0%, #3B82F6 100%)",
                      fontFamily: FONT_DISPLAY,
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <br className="hidden sm:block" /> into your business?
                </h2>

                <p
                  className="text-sm sm:text-base max-w-xl mx-auto mb-8 sm:mb-10 leading-relaxed"
                  style={{
                    color: "#64748B",
                    fontFamily: FONT_BODY,
                    fontStyle: "italic",
                ...
                >
                  Whether you're automating your first workflow or engineering
                  a full enterprise platform, we're ready to partner with you
                  from day one.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <Link
                    to="/contact"
                    className="group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full text-white font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5"
                    style={{
                      background:
                        "linear-gradient(135deg, #6366F1 0%, #3B82F6 100%)",
                      boxShadow:
                ...
                <div
                  className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-8 sm:mt-10 pt-6 sm:pt-8"
                  style={{
                    borderTop:
